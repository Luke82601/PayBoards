...
import initializeChessBoard from './initializeChessBoard.js';
  ...
  handleClick(i) {
    ...
    if(this.state.sourceSelection === -1){
      if(!squares[i] || squares[i].player !== this.state.player){
        ...
        squares[i].style = {backgroundColor: "RGB(111,143,114)"}; // Emerald from http://omgchess.blogspot.com/2015/09/chess-board-color-schemes.html
        this.setState({
