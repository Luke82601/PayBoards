...
class App extends React.Component {
  ...
  moveSelected(event) {
    ...
    const columns = Number(target.charAt());
  ...
  render() {
    ...
    const whichPiece = (square, index, i) => {
      ...
      if (square[0] === 'bk') {
        return (
          <img name={`${index}${i}`} className="piece" alt="" src="images/blackking.png" />
        );
      }
      if (square[0] === 'bq') {
        return (
          <img name={`${index}${i}`} className="piece" alt="" src="images/blackqueen.png" />
        );
      }
      if (square[0] === 'bp') {
        return (
          <img name={`${index}${i}`} className="piece" alt="" src="images/blackpawn.png" />
        );
      }
      if (square[0] === 'wr1' || square[0] === 'wr2') {
        return (
          <img name={`${index}${i}`} className="piece" alt="" src="images/whiterook.png" />
        );
      }
      if (square[0] === 'wkn1' || square[0] === 'wkn2') {
        return (
          <img name={`${index}${i}`} className="piece" alt="" src="images/whiteknight.png" />
        );
      }
      if (square[0] === 'wb1' || square[0] === 'wb2') {
        return (
          <img name={`${index}${i}`} className="piece" alt="" src="images/whitebishop.png" />
        );
      }
      if (square[0] === 'wk') {
        return (
          <img name={`${index}${i}`} className="piece" alt="" src="images/whiteking.png" />
        );
      }
      if (square[0] === 'wq') {
        return (
          <img name={`${index}${i}`} className="piece" alt="" src="images/whitequeen.png" />
        );
      }
      if (square[0] === 'wp') {
        return (
